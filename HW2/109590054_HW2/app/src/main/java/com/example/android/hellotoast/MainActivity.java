...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View button_zero = (View) findViewById(R.id.button_zero);
        button_zero.setBackgroundColor(getColor(android.R.color.darker_gray));
    }
    ...
    public void countUp(View view) {
        View button_zero = (View) findViewById(R.id.button_zero);
        button_zero.setBackgroundColor(getColor(android.R.color.black));
        mCount++;
        if (mCount % 2 == 0)
            view.setBackgroundColor(getColor(android.R.color.holo_orange_dark));
        else
